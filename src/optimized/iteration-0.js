// METADATA
// 8 KB of text (content is this file copy-pasted)
// 470ms average
// 8KB/470ms = 0.017KB/ms, 59x speed up required
...
const _merges = trainBPE(corpus, separators, merges, vocab, inverse).merges
const e = performance.now();
console.log(`merges: ${_merges}`);
